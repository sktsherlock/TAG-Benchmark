...
g = dgl.load_graphs('/mnt/v-wzhuang/Amazon/Books/Amazon-Books-Children.pt')[0][0]
...
np.save('/mnt/v-wzhuang/TAG-Benchmark/data/amazon/Books/Children/deepwalk_feat.npy', embedding)
print("finish")