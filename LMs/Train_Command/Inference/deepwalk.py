...
g = dgl.load_graphs('/mnt/v-wzhuang/Amazon/Electronics/Amazon-Electronics-Photo.pt')[0][0]
...
np.save('/mnt/v-wzhuang/TAG-Benchmark/data/amazon/Electronics/Photo/deepwalk_feat.npy', embedding)
print("finish")