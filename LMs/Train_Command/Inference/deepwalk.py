...
g = dgl.load_graphs('/mnt/v-wzhuang/Amazon/Sports_and_Outdoors/Amazon-Sports-Fitness.pt')[0][0]
...
np.save('/mnt/v-wzhuang/TAG-Benchmark/data/amazon/Sports/Fitness/deepwalk_feat.npy', embedding)
print("finish")