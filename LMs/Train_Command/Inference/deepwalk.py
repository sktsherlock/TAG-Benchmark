...
g = dgl.load_graphs('/mnt/v-wzhuang/TAG-Benchmark/data/amazon/Electronics/Computers/Electronics-Computers.pt')[0][0]
...
np.save('/mnt/v-wzhuang/TAG-Benchmark/data/amazon/Electronics/Computers/deepwalk_feat.npy', embedding)
print("finish")