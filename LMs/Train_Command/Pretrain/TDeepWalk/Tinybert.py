...
"""
CUDA_VISIBLE_DEVICES=7 /usr/bin/env python sweep/dist_runner.py LMs/trainLM.py --att_dropout=0.1 --cla_dropout=0.1 --dataset=arxiv_TA --dropout=0.1 --epochs=4 --eq_batch_size=100 --eval_patience=50000 --label_smoothing_factor=0.1 --lr=2e-05 --model=Distilbert --warmup_epochs=1 --gpus=7 #--freeze=1
